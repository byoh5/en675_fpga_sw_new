...
_regs_ BF_13(UINT TX_DATBIT : 1 ,UINT TX_DATTYPE : 1 ,UINT TX_CLKOE : 1 ,UINT TX_CLKEDGE : 1 ,UINT TX_CLKSEL : 1 ,UINT TX_CRSCHK : 1 ,UINT TX_COLCHK : 1 ,UINT TX_RTYEN : 1 ,UINT TX_PAUSE_EN : 1 ,UINT TX_PAUSE : 1 ,UINT _rev0 : 10, UINT TX_RTYLMT : 4 , UINT _rev1 : 8 ) _rege_ _ETH_13;
