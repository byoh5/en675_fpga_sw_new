...
#if 0	// ddr write test
	IM_YADR0w(DDR_BASE_ISP_ENC3+ISP_DDR_ENC_SIZE);
	IM_CADR0w(DDR_BASE_ISP_ENC3+ISP_DDR_ENC_SIZE+ISP_DDR_8BIT_SIZE);
	IM_IVSEL0w(0);
	IM_ISEL0w(0xC);
	YCW_CK0_SELw(2);
	YCW_CK0_PDw(1);
...
#if 1
	#define ISP1_DDR_4BIT_SIZE	((((RP(PO_HW)+8)*RP(PO_VW))<<2)>>(3+4))			// TODO KSH - DZOOM 사용 시 +8 필요 -> Single에서 개선될 수 있음
	#define ISP1_DDR_8BIT_SIZE	((((RP(PO_HW)+8)*RP(PO_VW))<<3)>>(3+4))

	#define DDR_BASE_ISP_IM_Y1_PO	(DDR_BASE_ISP_ENC3+ISP_DDR_ENC_SIZE)
	#define DDR_BASE_ISP_IM_C1_PO	(DDR_BASE_ISP_IM_Y1_PO+ISP1_DDR_8BIT_SIZE)
	#define DDR_BASE_ISP_IM_Y1_P1	(DDR_BASE_ISP_IM_C1_PO+ISP1_DDR_4BIT_SIZE)
	#define DDR_BASE_ISP_IM_C1_P1	(DDR_BASE_ISP_IM_Y1_P1+ISP1_DDR_8BIT_SIZE)
	#define DDR_BASE_ISP_IM_Y1_P2	(DDR_BASE_ISP_IM_C1_P1+ISP1_DDR_4BIT_SIZE)
	#define DDR_BASE_ISP_IM_C1_P2	(DDR_BASE_ISP_IM_Y1_P2+ISP1_DDR_8BIT_SIZE)

	IM_YADR1_P0w(DDR_BASE_ISP_IM_Y1_PO);
	IM_CADR1_P0w(DDR_BASE_ISP_IM_C1_PO);
	IM_YADR1_P1w(DDR_BASE_ISP_IM_Y1_P1);
	IM_CADR1_P1w(DDR_BASE_ISP_IM_C1_P1);
	IM_YADR1_P2w(DDR_BASE_ISP_IM_Y1_P2);
	IM_CADR1_P2w(DDR_BASE_ISP_IM_C1_P2);
#endif

#if 1//defined(USE_DIG_CH2)
	//#define DDR_BASE_ISP_IM_Y2_PO	(DDR_BASE_ISP_ENC3+ISP_DDR_ENC_SIZE)
	#define DDR_BASE_ISP_IM_Y2_PO	(DDR_BASE_ISP_IM_C1_P2+ISP_DDR_4BIT_SIZE)
