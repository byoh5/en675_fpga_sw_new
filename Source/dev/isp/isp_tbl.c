...
void Isp_Ddr_Cong(void)
{
	...
	#define DDR_BASE_ISP_IM_C1_PO	(DDR_BASE_ISP_IM_Y1_PO+ISP_DDR_8BIT_SIZE)
	#define DDR_BASE_ISP_IM_Y1_P1	(DDR_BASE_ISP_IM_C1_PO+ISP_DDR_4BIT_SIZE)
	#define DDR_BASE_ISP_IM_C1_P1	(DDR_BASE_ISP_IM_Y1_P1+ISP_DDR_8BIT_SIZE)
	#define DDR_BASE_ISP_IM_Y1_P2	(DDR_BASE_ISP_IM_C1_P1+ISP_DDR_4BIT_SIZE)
	#define DDR_BASE_ISP_IM_C1_P2	(DDR_BASE_ISP_IM_Y1_P2+ISP_DDR_8BIT_SIZE)
