...
extern void BDmaRegView(UINT nCH);
...
extern ENX_OKFAIL SdioDataIO_async(UINT nCH, eSDIO_DIO_TYPE iotype, ULONG MemDst, UINT BlkAdr, UINT BlkCnt);
...
extern void ShaCalc_isr_async(BYTE *apbSrc, UINT len, SHAmode mode);
extern void ShaCalc_isr(BYTE *apbSrc, UINT len, SHAmode mode);
extern void ShaCalc_rtos_async(BYTE *apbSrc, UINT len, SHAmode mode);
extern void ShaCalc_rtos(BYTE *apbSrc, UINT len, SHAmode mode);
