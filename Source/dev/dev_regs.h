...
_regs_ BF_14(UINT DAT_CRCERR : 1 ,UINT _rev0 : 19, UINT IO_IRQ : 1 ,UINT IO_IRQ_CLR : 1 ,UINT IO_IRQ_EN : 1 ,UINT CMD_IRQ : 1 ,UINT CMD_IRQ_CLR : 1 ,UINT CMD_IRQ_EN : 1 ,UINT DAT_IRQ : 1 ,UINT DAT_IRQ_CLR : 1 ,UINT DAT_IRQ_EN : 1 ,UINT CMD53_OP : 1 ,UINT DAT_WE : 1 ,UINT DAT_EN : 1 ) _rege_ _SDIO_REG13;
...
extern UINT GpioGetOut(UINT nCH);
...
extern UINT GpioGetIrqEn(UINT nCH);
...
extern UINT SdioGetBitMode(UINT nCH);
extern void SdioSet1BitMode(UINT nCH);
extern void SdioSet4BitMode(UINT nCH);
...
extern void SdioSetCmdDataS(UINT nCH, eSDIO_DAT_IO_TYPE esditType, UINT nCmd);
extern UINT SdioGetCmdDataS(UINT nCH, eSDIO_DAT_IO_TYPE esditType);
extern void SdioSetCmdDataM(UINT nCH, eSDIO_DAT_IO_TYPE esditType, UINT nCmd);
extern UINT SdioGetCmdDataM(UINT nCH, eSDIO_DAT_IO_TYPE esditType);
...
extern UINT SdioCdRead(const BYTE *buff, UINT sector, UINT count);
extern UINT SdioCdWrite(const BYTE *buff, UINT sector, UINT count);
