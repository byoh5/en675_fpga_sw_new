    ...
    )
{
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.picX = 416;//3840;//2048;//1920;//3840;//1920;//416;//iValue;
    //if (WAVE_GetValue(fp, "SourceHeight", &iValue) == 0)
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.picY = 240;//2160;//1600;//1200;//1080;//2160;//1080;//240;//256;////iValue;
    //if (WAVE_GetValue(fp, "FramesToBeEncoded", &iValue) == 0)
    //    goto __end_parse;
    //else
        pEncCfg->NumFrame = 5;//3;//5;//iValue;
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.decodingRefreshType = 1;//0;//iValue;
...
/*#define FIXED_BIT_RATIO 49
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.intraPeriod = 0;//30;//iValue;
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.maxNumMerge = 3;//1;//iValue;

    //if (WAVE_GetValue(fp, "EnDBK", &iValue) == 0)
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.disableDeblk = 1;//0;//!1;//!(iValue);
    ...
    //    goto __end_parse;
    //else
        pEncCfg->RcBitRate = 100000;//iValue;
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.maxDeltaQp = 10;//iValue;
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.initialRcQp = -1;//63;//iValue;
    ...
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.bgDetectEnable = 1;//0;//iValue;

    //if (WAVE_GetValue(fp, "BgThDiff", &iValue) == 0)
    //    goto __end_parse;
    //else
        pEncCfg->waveCfg.bgThrDiff = 0;//8;//iValue;
