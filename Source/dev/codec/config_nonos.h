...
//#	ddefine PLATFORM_WIN32 3
//#elif defined(linux) || defined(__linux) || defined(ANDROID)
//#	define PLATFORM_LINUX
//#elif defined(unix) || defined(__unix)
//#   ddefine PLATFORM_QNX f
//#else
...
#ifdef WAVE521C_DUAL
#define CORE_6_BIT_CODE_FILE_PATH   "chagall_dual.bin"     // for wave521
#else
#define CORE_6_BIT_CODE_FILE_PATH   "chagall.bin"     // for wave521
#endif

#define SUPPORT_NEW_SCHEDULER   // test for new scheduler
//------------------------------------------------------------------------------
// OMX
//------------------------------------------------------------------------------
...
#if defined(WAVE521C_DUAL)
#define SUPPORT_64BIT_MEM_ADDR
#endif /* WAVE521 || WAVE521C */
